/**
 * @file 	oilcooling_wpr_2d.cpp
 * @brief 	2D example to show the filling process of oil cooling system in a running electric motor.
 * @details This is the feasibility verification without particle relaxation for the 3D model based on the experimental study of the team
